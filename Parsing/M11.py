...
template_line_tables = [
    ...
    [
        ...
        [
            {"text": "[\S\s]*", "save": "дата составления"},
            {"text": "[\S\s]*", "save": "код вида операции"},
            {"text": "[\S\s]*", "save": "структурное подразделение отправителя"},
            {"text": "[\S\s]*", "save": "табельный номер отправителя"},
            {"text": "[\S\s]*", "save": "структурное подразделение получателя"},
            {"text": "[\S\s]*", "save": "табельный номер получателя"},
            {"text": "[\S\s]*", "save": "корреспондирующий счет -> счет, субсчет"},
            {
                "text": "[\S\s]*",
    ...
    [
        ...
        [
            {"text": "[\S\s]*", "save": "корреспондирующий счет (вторая таблица)"},
            {"text": "[\S\s]*", "save": "материальные ценности -> наименование"},
            {"text": "[\S\s]*"},
            {
                "text": "[\S\s]*",
                "save": "материальные ценности -> номенклатурный номер",
            },
            {"text": "[\S\s]*", "save": "характеристика"},
            {"text": "[\S\s]*", "save": "заводской номер"},
            {"text": "[\S\s]*", "save": "инвентарный номер"},
            {"text": "[\S\s]*", "save": "сетевой номер"},
            {"text": "[\S\s]*", "save": "единица измерения -> код"},
            {"text": "[\S\s]*", "save": "единица измерения -> наименование"},
            {"text": "[\S\s]*", "save": "количество -> затребовано"},
            {"text": "[\S\s]*", "save": "количество -> отпущено"},
            {"text": "[\S\s]*", "save": "цена, руб. коп."},
            {"text": "[\S\s]*", "save": "сумма без учета НДС, руб. коп"},
            {"text": "[\S\s]*", "save": "порядковый номер по складской картотеке"},
            {"text": "[\S\s]*", "save": "местонахождение"},
            {
                "text": "[\S\s]*",
...
def parse_M11(path: str) -> dict[str, list[str] | str]:
    ...
    with fitz.open(path) as doc:
        for table, template_table in zip(doc[0].find_tables(), template_line_tables):
